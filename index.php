...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/image/logo1.png">
    <!-- Preload CSS and JavaScript -->
    <link rel='stylesheet' type='text/css' href='assets/css/style.css'>
    <link rel="preload" as="style" href="https://www.smarteyeapps.com/build/assets/style-324d1a7d.css">
        ...
        <div class="container-xl bg-white">
            <div class="row m-0">
                <div class="col-lg-3 nav-col align-self-center">
                    <a href="">
                        <img class="max-250" src="assets/image/logo1.png" alt="">
                    </a>
                ...
                <div id="menu" class="col-lg-7 col-md-8 d-none d-lg-block align-self-center  justify-content-center d-flex">
                    <ul class="fw-bold main-nav">
                        <li class="float-start px-3 py-4"><a href="">Trang chủ</a> </li>
                        <li class="float-start px-3 py-4"><a href="#services">Tính năng</a> </li>
                        <li class="float-start px-3 py-4"><a href="#about_us">Giới thiệu</a></li>
                        <li class="float-start px-3 py-4"><a href="">Hình ảnh</a></li>
                        <li class="float-start px-3 py-4"><a href="#logins">Đăng nhập</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 d-none d-lg-block align-self-center text-end ">
                    <a href="hms/registration.php">
                        <button class="btn btn-primary float-end fs-8 fw-bolder">Đăng kí</button>
                    </a>
                </div>
            </div>
        </div>
        <!-- ################# Hero Section Starts Here #######################--->
        <div id="homeCarousel" class="carousel slide container-fluid home-slid" data-ride="carousel" data-interval="3000">
            <div class="container-xl">
                <div class="row">
                    <div class="col-lg-6 py-5 slid-detail align-self-center">
                        <h1 class="fw-bolder fs-11">HKL <span class="text-primary">Hệ thống quản lý bệnh viện</span></h1>
                        <p class="pt-4">Bạn có thể quản lý lịch hẹn, hồ sơ bệnh nhân và nhiều thông tin khác dễ dàng và hiệu quả hơn.</p>
                        <div class="pt-5">
                            <a href="hms/user-login.php">
                                <button class="btn btn-primary shadow-md fw-bold p-3 px-5">Đặt lịch hẹn</button>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 py-5 px-5">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="assets/image/Areas&Rooms/Hospital operating theater HKL.png" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="assets/image/Areas&Rooms/Hospital patient room HKL.png" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="assets/image/Areas&Rooms/Hospital waiting room HKL.png" alt="Third slide">
                            </div>
                        </div>
