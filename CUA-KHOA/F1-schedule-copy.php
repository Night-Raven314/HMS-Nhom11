    ...
    <body class="g-sidenav-show"
        ...
        <main class="main-content border-radius-lg ">
                ...
                <div class="container-fluid py-1 px-3">
                    ...
                    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                        ...
                        <ul class="navbar-nav  justify-content-end">
                            ...
                            <li class="nav-item d-flex align-items-center">
                                <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="sign-in.php">Đăng xuất</a>
                            </li>
            ...
            <div class="container-fluid py-4">
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span class="text-xs font-weight-bold mb-0" id="appointment-date">31/10/2024 16:30</span>
                                                </td>
                                                ...
                                                <!-- <td class="align-middle text-center">
                                                    <p class="btn btn-primary btn-sm" id="edit-button" href="#">Edit</p>
                                                </td> -->
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <!-- Popup Section cho Đăng Ký -->
                <div id="register-popup" class="popup" style="display: none;" onclick="div_hide('register-popup')">
                    <div id="popupFormContainer" onclick="event.stopPropagation()"> <!-- Ngăn sự kiện click nổi bọt -->
                        <div class="card">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Đăng ký lịch khám</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form role="form">
                                    ...
                                    <div class="input-group input-group-outline mb-3">
                                        <label for="floatingInputDate" style="margin-right: 10px;">Ngày khám</label>
                                        <input type="date" class="form-control" required>
                                    </div>
                                    <div class="input-group input-group-outline mb-3">
                                        <label for="floatingInputDate" style="margin-right: 10px;">Giờ khám</label>
                            ...
                            <div class="card-body">
                                <form role="form">
                                    <div class="input-group input-group-outline mb-3" style="position: relative;">
                                        ...
                                        <input type="time" class="form-control" style="padding: 10px 10px 10px 10px;" required>
                                    </div>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">Cập nhật</button>
                                    </div>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-lg btn-outline-primary btn-lg w-100 mt-4 mb-0" onclick="div_hide('edit-popup')">Thoát</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <!-- edit button -->
        <script>
            // Lấy ngày hẹn từ phần tử
            const appointmentDateStr = document.getElementById('appointment-date').innerText;
            // Chuyển đổi thành đối tượng Date
            const appointmentDate = new Date(appointmentDateStr.replace(/(\d{2})\/(\d{2})\/(\d{4})/, '$3-$2-$1'));
            ...
            if (appointmentDate > currentDate) {
                // Nếu ngày hẹn trong tương lai, hiển thị nút Edit
                document.getElementById('edit-button').style.display = 'inline-block';
            } else {
                // Nếu không, ẩn nút Edit
