...
define('google_app_callback_url', 'http://localhost:8080/HMS-Nhom11/backend/assets/include/oauth/g-authenticate.php');

// Facebook Authentication
define('facebook_app_id', '8730803523625712');
define('facebook_app_secret', 'f7438a3246ad2a0a75bc9ace3c2c5fa6');
define('facebook_app_callback_url', 'http://localhost:8080/HMS-Nhom11/backend/assets/include/oauth/f-authenticate.php');
...
define('vnpay_payment_callback_url', 'http://localhost:8080/HMS-Nhom11/backend/assets/include/payment/vnpay_payment_auth.php');
