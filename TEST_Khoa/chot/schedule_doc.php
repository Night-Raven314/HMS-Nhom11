    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="../../TEST_Khoa/chot/schedule_doc.php">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href=' #popup_health_metrics-<?php echo $appt_id; ?>' class=' text-secondary font-weight-bold text-xs edit-btn'
                                                            ...
                                                            <form name="update_health_metrics" role="form" method="POST">
                                                                ...
                                                                <div class="text-center">
                                                                    <button type="button" class="btn btn-lg btn-outline-primary btn-lg w-100 mt-4 mb-0"
                                                                        onclick="div_hide('popup_health_metrics-<?php echo $appt_id; ?>')">Thoát</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- Popup đơn thuốc -->
                                                <div id="popup_prescription-<?php echo $appt_id; ?>" class="overlay_flight_traveldil">
                                                    <div class="card popup-cont">
                                                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                                                <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">
                                                            ...
                                                            <form name="prescription_form" method="POST">
                                                                ...
                                                                <div class="text-center">
                                                                    <button type="button" class="btn btn-lg btn-outline-primary w-100 mt-4 mb-0"
                                                                        onclick="div_hide('popup_prescription-<?php echo $appt_id; ?>')">Thoát</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
